...
import {
	createSocialMediaRelevanceScoreLlmSchema,
	type SocialMediaRelevanceScoreEntry,
	type SocialMediaRelevanceScoreValidation,
} from "@/schemas/SocialMediaRelevanceScore.js";
...
export function parseSocialMediaRelevanceScoreJson(
	raw: string,
	validation: SocialMediaRelevanceScoreValidation,
): SocialMediaRelevanceScoreEntry[] {
	let parsed: unknown;
	try {
	...
	const schema = createSocialMediaRelevanceScoreLlmSchema(validation);
